...
import 'package:flutter_robot/car.dart';
...
class _MainPage extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('bluetooth car'),
      ),
      body: Container(
        child: ListView(
          children: <Widget>[
  ...
  void _startChat(BuildContext context, BluetoothDevice server) {
    ...
    Navigator.of(context).push(MaterialPageRoute(builder: (context) { return CarPage(server: server); }));
  }
